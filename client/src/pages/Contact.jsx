    ...
    <>
      ...
      <div>
        ...
        >
          ...
          <span className="business-name">Mimi's Kitchen & Grill</span> for your
          catering needs and online orders! We're excited to help make your
          event unforgettable.
        </p>
        ...
        >
          ...
          <p className="lead my-0">
            <a
              href="https://www.facebook.com/profile.php?id=61563933896693&mibextid=LQQJ4d"
              target="_blank"
            >
          ...
          <p className="lead my-0">
            <a
              href="https://www.instagram.com/mimis_kitchen_grill/"
              target="_blank"
            >
              <FaSquareInstagram size={25} color="#f09433" />
              Instagram
            </a>
          </p>
          <p className="lead my-0">
            <a
              className=".instagram"
              href="https://www.tiktok.com/@kitchen_and_grill"
              target="_blank"
            >
              <AiFillTikTok size={25} color="#fe2858" />
              Tik Tok
            </a>
          </p>
        </p>
        ...
        >
          Event Inquiries:
          <p className="lead my-0">
            For event inquiries, consultations, and catering quotes, please
            email us at [Your Event Email Address].
          </p>
        </p>
        <p
          className="px-4 lead font-weight-bold"
        ...
        >
          Feedback:
          <p className="lead my-0">
            We appreciate your feedback! Let us know how we did by emailing
        ...
        >
          Customer Support:
          <p className="lead my-0">
            For customer support, please email us at [Your Customer Support
            Email Address] or call us at [Your Customer Support Phone Number].
          </p>
          <p className="lead mt-5">
            At <span className="business-name">Mimi's Kitchen & Grill</span>, we
            always look forward to creating an exceptional culinary experience
