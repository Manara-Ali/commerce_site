  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn more about Mimi's Kitchen & Grill history and how this amazing culinary chef came about."
        />
      ...
      <div>
        ...
        >
          ...
          for creating unforgettable dining experiences, our catering services
          are designed to elevate any event, big or small.
        </p>
        <img
          className="my-5 border"
          src={foodMood}
        ...
        >
          ...
          team is dedicated to providing impeccable service and exquisite
          cuisine that leaves a lasting impression.
        </p>
        <img
          className="my-5 border"
          src={cookBook}
        ...
        <p
          ...
          style={{ fontSize: "1.5rem", fontWeight: "400", color: "#000" }}
        >
          At Mimi's Kitchen & Grill, we understand that each event is unique,
          which is why we work closely with our clients to customize menus that
          reflect their tastes and preferences. From elegant plated dinners to
          interactive food stations, we create culinary experiences that are as
          distinctive as they are delicious.
        </p>
        <img
          className="my-5 border"
          src={openedFride}
        ...
        >
          With a commitment to excellence and a passion for food, Silver is your
          partner in creating unforgettable moments. Contact us today to discuss
          how we can make your next event truly exceptional.
        </p>
      </div>
    </>
  );
